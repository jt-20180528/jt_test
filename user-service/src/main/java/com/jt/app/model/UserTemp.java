...
public class UserTemp implements Serializable {
    ...
    @Column(columnDefinition = "tinyint(1) DEFAULT 1 COMMENT '用户状态：1正常、0禁用'")
    ...
    public UserTemp(String loginName, String loginPasswd, String userName, Integer sex, String telephone,
