...
public class LotteryUser implements Serializable {
    ...
    public LotteryUser(Integer id, String name, Integer lotteryType, Integer lotteryStatus, Integer lotteryNumber, Integer tenementId,Integer winLotteryStatus) {
        this.id = id;
        this.name = name;
